...
class Network(nn.Module):
    def __init__(self):
        ...
        self.conv_3 = nn.Conv2d(128,256 ,2)
        self.bn_3 = nn.BatchNorm2d(64)
#         self.mp_3 = nn.MaxPool2d(2)
        self.dp_3 = nn.Dropout(0.2)
        
        self.conv_4 = nn.Conv2d(256,512, 2)
        self.bn_4 = nn.BatchNorm2d(128)
#         self.mp_4 = nn.MaxPool2d(2)
        self.dp_4 = nn.Dropout(0.2)
        
        self.conv_5 = nn.Conv2d(512,1024, 2)
        self.bn_5 = nn.BatchNorm2d(256)
#         self.mp_5 = nn.MaxPool2d(2)
        self.dp_5 = nn.Dropout(0.2)
        
        self.conv_6 = nn.Conv2d(1024,1024, 2)
        self.dp_6 = nn.Dropout(0.2)
        
        self.conv_7 = nn.Conv2d(1024,1024, 2)
        self.dp_7 = nn.Dropout(0.2)
        
        self.avg_pool = nn.AdaptiveAvgPool2d((1, 1))
        
        self.fc = nn.Linear(1024,248)
        
        self.conv_1 = nn.Conv2d(1, 3,3)
...
#     print("Epcch : ", epoch, " Loss : ", op_train_loss, " Accuracy : ", train_accuracy)
    ...
    print("\nConv Epoch - ",epoch, " Train Accuracy : ", train_accuracy, " Val Accuracy : ", test_accuracy,"\n\n")
