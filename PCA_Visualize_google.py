...
pca_result = pca.fit_transform(data_xg)
print("Google ", pca_result.shape, data_y.shape)
plt.scatter(pca_result[:,0], pca_result[:,1], c=data_y)
plt.savefig("Visualizations/google_pca.png")
...
plt.savefig("Visualizations/google_pca3d.png")